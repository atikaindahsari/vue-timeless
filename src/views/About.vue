  ...
  data() {
    return {
      items: [
        {
          id: 1,
          src: require("../assets/images/tim1.jpg"),
          name: 'Peter Melark',
          title: 'Director/Photographer'
        },
        {
          id: 2,
          src: require("../assets/images/tim2.jpg"),
          name: 'Katniss Everdeen',
          title: 'Photographer'
        },
        {
          id: 3,
          src: require("../assets/images/tim3.jpg"),
          name: 'Primrose Evelark',
          title: 'Freelancer'
        }
      ]
    };
